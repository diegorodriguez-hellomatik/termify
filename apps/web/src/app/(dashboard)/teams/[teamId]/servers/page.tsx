...
import { TeamServersList } from '@/components/teams/TeamServersList';
...
export default function TeamServersPage() {
  ...
  return (
    <div className="space-y-4">
      <ResourceSubNav teamId={teamId} activeTab="servers" />
      <TeamServersList teamId={teamId} canManage={canEdit} />
    </div>
  );
}
