...
import { TeamSnippetsList } from '@/components/teams/TeamSnippetsList';

export default function TeamSnippetsPage() {
  ...
  return (
    <div className="space-y-4">
      <ResourceSubNav teamId={teamId} activeTab="snippets" />
      <TeamSnippetsList teamId={teamId} canManage={canEdit} />
    </div>
  );
}
