...
import { TeamTerminalsList } from '@/components/teams/TeamTerminalsList';

export default function TeamTerminalsPage() {
  ...
  return (
    <div className="space-y-4">
      <ResourceSubNav teamId={teamId} activeTab="terminals" />
      <TeamTerminalsList teamId={teamId} canManage={canEdit} />
    </div>
  );
}
