...
import { TeamTasksList } from '@/components/teams/TeamTasksList';
...
export default function TeamTasksPage() {
  ...
  return (
    <div className="space-y-4">
      <ResourceSubNav teamId={teamId} activeTab="tasks" />
      <TeamTasksList teamId={teamId} teamMembers={team?.members || []} canManage={canEdit} />
    </div>
  );
}
